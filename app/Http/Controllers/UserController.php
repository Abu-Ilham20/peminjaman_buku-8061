...
class UserController extends Controller
{
    ...
    public function approve($slug)
    {
        ...
        $user->status = 'active';
        $user->save();
        return redirect('user-detail/' . $slug)->with('status', 'User successfully activeted');
    }
    ...
    public function destroy($slug)
    {
        ...
        return redirect('users')->with('delete', 'User successfully Banned');
    }

    public function userBanneds()
    {
